...
class LogSystem
{
     ...
     */
    friend LogSystem &operator<<(LogSystem &, const LogLevel::Levels &logLevel);
    /**
...
public:
    ...
    string get_subSystemName() { return subSystemName; }
    void set_subSystemName(const string &_subSystemName);
    LogLevel::Levels get_subSystemLogLevel() { return subSystemLogLevel; }
